<div class="tab-pane active" role="tabpanel" id="step3">
    <h3 class="text-center title_heading"><b>Step 1:</b> Application Form</h3>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('aadhaar') has-error @enderror">
                    ...
                    <input class="form-control" type="text" name="aadhaar" value="{{ old('aadhaar') }}"> 
                    @error('aadhaar')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group @error('dob') has-error @enderror">
                    ...
                    <input class="form-control" type="date" name="dob" placeholder="" value="{{ old('dob') }}">
                    @error('date')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group @error('father_name') has-error @enderror">
                    ...
                    <input class="form-control" type="text" name="father_name" placeholder="Enter Father's name" value="{{ old('father_name') }}"> 
                    @error('father_name')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group @error('mother_name') has-error @enderror">
                    ...
                    <input class="form-control" type="text" name="mother_name" placeholder="Enter Mother's name" value="{{ old('mother_name') }}"> 
                    @error('mother_name')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group @error('pwd') has-error @enderror">
                    ...
                    <select name="pwd" class="form-control" id="pwd">
                        <option value="No" @if(old('pwd') == 'No') selected @endif>No</option>
                        <option value="Yes" @if(old('pwd') == 'Yes') selected @endif>Yes</option>
                    </select>
                    @error('pwd')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
            ...
            <div class="col-md-6">
                <div class="form-group @error('alternate_contact') has-error @enderror">
                    ...
                    <input type="text" name="alternate_contact" class="form-control" value="{{ old('alternate_contact') }}">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group @error('residence') has-error @enderror">
                    ...
                    <select name="residence" class="form-control" id="residence">
                        ...
                        <option value="Urban" @if(old('residence') == 'Urban') selected @endif>Urban</option>
                        <option value="Rural" @if(old('residence') == 'Rural') selected @endif>Rural</option>
                    </select>
                    @error('residence')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('address_1') has-error @enderror">
                    ...
                    <textarea class="form-control" name="address_1">{{ old('address_1') }}</textarea>
                    @error('address_1')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
                </div>
            ...
            <div class="col-md-6">
                <div class="form-group @error('address_2') has-error @enderror">
                    ...
                    <textarea class="form-control" name="address_2">{{ old('address_2') }}</textarea>
                    @error('address_2')
                        <div class="small text-danger">{{$message}}</div>
                    @enderror 
                </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_board_name') has-error @enderror">
                    ...
                    <input type="text" name="intermediate_board_name" class="form-control" placeholder="Enter Education Board Name" value="{{ old('intermediate_board_name') }}">
            ...
            <div class="col-md-6">       
                <div class="form-group @error('intermediate_school_name') has-error @enderror">
                    ...
                    <input type="text" name="intermediate_school_name" class="form-control" placeholder="Enter School or Institute Name" value="{{ old('intermediate_school_name') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_qualification_status') has-error @enderror">
                    ...
                    <select name="intermediate_qualification_status" class="form-control"/>
                        <option value="Passed" @if(old('intermediate_qualification_status') == 'Passed') selected @endif>Passed</option>
                        <option value="Appearing" @if(old('intermediate_qualification_status') == 'Appearing') selected @endif>Appearing</option>
                    </select>
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_passing_year') has-error @enderror">
                    ...
                    <input type="date" name="intermediate_passing_year" class="form-control" id="datepicker" value="{{ old('intermediate_passing_year') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_total_marks') has-error @enderror">
                    ...
                    <input type="number" name="intermediate_total_marks" class="form-control" value="{{ old('intermediate_total_marks') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_obtained_marks') has-error @enderror">
                    ...
                    <input type="number" name="intermediate_obtained_marks" class="form-control" value="{{ old('intermediate_obtained_marks') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('intermediate_percentage_mark') has-error @enderror">
                    ...
                    <input type="text" name="intermediate_percentage_mark" class="form-control" value="{{ old('intermediate_percentage_mark') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('matric_board_name') has-error @enderror">
                    <label class="control-label">Name of Board <span class="mandatory">*</span></label> 
                    <input type="text" name="matric_board_name" class="form-control" placeholder="Enter Education Board Name" value="{{ old('matric_board_name') }}">
            ...
            <div class="col-md-6">       
                <div class="form-group @error('matric_school_name') has-error @enderror">
                    <label class="control-label">Name of School / Institute <span class="mandatory">*</span></label> 
                    <input type="text" name="matric_school_name" class="form-control" placeholder="Enter School or Institute Name" value="{{ old('matric_school_name') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('matric_passing_year') has-error @enderror">
                    <label class="control-label">Year of Passing <span class="mandatory">*</span></label> 
                    <input type="date" name="matric_passing_year" class="form-control" id="datepicker" value="{{ old('matric_passing_year') }}">
            ...
            <div class="col-md-6">
                <div class="form-group  @error('matric_total_marks') has-error @enderror">
                    <label class="control-label">Total Marks <span class="mandatory">*</span></label>
                    <input type="number" name="matric_total_marks" class="form-control" value="{{ old('matric_total_marks') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('matric_obtained_marks') has-error @enderror">
                    <label class="control-label">Obtained Marks <span class="mandatory">*</span></label>
                    <input type="number" name="matric_obtained_marks" class="form-control" value="{{ old('matric_obtained_marks') }}">
            ...
            <div class="col-md-6">
                <div class="form-group @error('matric_percentage_mark') has-error @enderror">
                    <label class="control-label">Percentage % / Grade <span class="mandatory">*</span></label>
                    <input type="text" name="matric_percentage_mark" class="form-control" value="{{ old('matric_percentage_mark') }}">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6">
                <div class="form-group @error('family_members') has-error @enderror">
                    ...
                    <input type="text" name="family_members" class="form-control" value="{{ old('family_members') }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group @error('monthly_income') has-error @enderror">
                    ...
                    <input type="text" name="monthly_income" class="form-control" value="{{ old('monthly_income') }}">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group @error('is_govt_employee') has-error @enderror">
                    <label class="control-label">Is Your Father / Mother Govt. Employee <span class="mandatory">*</span></label> 
                    <input type="radio" name="is_govt_employee" value="0" id="is_govt_no"><label for="is_govt_no">No</label>
                    <input type="radio" name="is_govt_employee" value="1" id="is_govt_yes"><label for="is_govt_yes">Yes</label>
                </div>
            </div>
    ...
    <div class="row col-md-12">
        ...
        <div class="form-group">
            ...
            <select class="" name="how_hear_about">
                ...
                <option value="Newspaper" @if(old('how_hear_about') == 'Newspaper') selected @endif>Newspaper</option>
                <option value="TV/Radio" @if(old('how_hear_about') == 'TV/Radio') selected @endif>TV/Radio</option>
                <option value="Govt. Seminars" @if(old('how_hear_about') == 'Govt. Seminars') selected @endif>Govt. Seminars</option>
                <option value="Google" @if(old('how_hear_about') == 'Google') selected @endif>Google</option>
                <option value="Facebook" @if(old('how_hear_about') == 'Facebook') selected @endif>Facebook</option>
                <option value="Instagram" @if(old('how_hear_about') == 'Instagram') selected @endif>Instagram</option>
                <option value="Friend/Relative" @if(old('how_hear_about') == 'Friend/Relative') selected @endif>Friend/Relative</option>
                <option value="School/Institute" @if(old('how_hear_about') == 'School/Institute') selected @endif>School/Institute</option>
                <option value="Banner/Hoardings" @if(old('how_hear_about') == 'Banner/Hoardings') selected @endif>Banner/Hoardings</option>
                <option value="Other" @if(old('how_hear_about') == 'Other') selected @endif>Other</option>
            </select>
        </div>
        <hr>
